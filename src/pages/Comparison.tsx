        ...
        >
            ...
            >
                ...
                >
                    ...
                    <p className="mb-1">
                        The delivery van enters the neighborhood from the
                        outskirts and stops at key loading points. From each
                        stop, the driver sets out on foot to deliver packages to
                        nearby stores.
                    </p>
                    <p>
                        The van follows an optimized route between loading
                        zones, and each walking segment is planned to balance
                        delivery loads and minimize distance, ensuring an
                        efficient flow through the urban area.
                    </p>
                </motion.div>
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-start bg-green-50 p-2 rounded-lg">
                                ...
                                <span className="text-sm">
                                    Higher cargo capacity for bulk deliveries
                                </span>
                            </li>
                            <li className="flex items-start bg-green-50 p-2 rounded-lg">
                                <FaRoute className="text-green-500 mt-1 mr-2 flex-shrink-0" />
                                <span className="text-sm">
                                    Long range for suburban routes
                                </span>
                            </li>
                        </ul>
                    </motion.div>
                ...
                <motion.div
                    ...
                    className="mt-6"
                >
                    <h3 className="text-xl font-semibold text-black mb-3 border-b border-blue-100 pb-2">
                        Operating Costs - Source: Spanish Ministry of Transport
                    </h3>
        ...
        >
            ...
            >
                ...
                >
                    <p className="mb-2 font-semibold">How it works?</p>
                    <p className="mb-1">
                        Autonomous robots depart from a central warehouse and
                        handle deliveries entirely on foot within pre-assigned
                        urban zones. Each robot is responsible for one cluster
                        of stores.
                    </p>
                    <p>
                        Delivery areas are grouped using clustering algorithms,
                        and each robot follows a closed-loop route that respects
                        its weight capacity and battery range, perfect for
                        navigating dense, pedestrian-friendly cities.
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="mt-6"
                >
                    <h3 className="text-xl font-semibold text-purple-700 mb-3 border-b border-purple-100 pb-2">
                        Operating Costs - Source:{" "}
                        <a
    ...
    return (
        <div className="page-transition">
            <div className="max-w-7xl mx-auto px-4">
                <Title
                    title="Delivery Models Comparison"
                    subtitle=" Hover over each delivery model to explore its features in detail. Each approach offers unique advantages for different urban delivery scenarios."
                />
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col justify-between h-full bg-gray-400/20 backdrop-blur-sm rounded-lg p-3 text-black border border-gray-400/30 mt-auto">
                                            <p className="font-medium mb-1">
                                                Conventional delivery vans have
                                                been the backbone of logistics
                                                for decades.
                                            </p>
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 rounded-xl shadow-lg text-white mb-12 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="mb-4 text-sm">
                                Experience both delivery models in an
