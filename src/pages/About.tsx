            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-700 mb-4 leading-relaxed">
                        DELIVETTER is an academic project focused on redesigning
                        last-mile delivery in urban areas through the
                    ...
                    <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
                        <li>
                            <strong>Model 1 (M1)</strong>: Van-based delivery
                            with pedestrian segments
                        </li>
                        <li>
                            <strong>Model 2 (M2)</strong>: Fully autonomous
                            delivery using urban robots
                        </li>
                    </ul>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    >
                        ...
                        <p className="text-gray-700">
                            Developed as part of a Bachelor's Degree in Data
                            Science at UPV, this project brings together data
                            modeling, logistics, and environmental impact
                            assessment to evaluate innovative delivery systems.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-gray-700">
                            We apply graph theory, clustering algorithms and
                            spatial analysis techniques to model real urban
                            logistics challenges. Using Python and geospatial
                            libraries, we simulate and evaluate delivery
                            strategies based on travel time, distance and load
                            balancing.
                        </p>
                    </motion.div>
                </div>
                ...
                >
                    ...
                    <p className="text-gray-700 mb-6 leading-relaxed">
                        ...
                        Catastro, and Valencia's open data portal to build
                        multimodal urban graphs. Using Python libraries like
                        OSMnx and geopandas, we developed and simulated delivery
                        routes optimized by walking distance, vehicle access,
                    ...
                    >
                        ...
                        <figcaption className="text-sm text-center text-gray-500 mt-2">
                            Warehouses (red), stores (blue), and combined use
                            (black) extracted using PyCatastro over Valencia's
                ...
                >
                    ...
                    <p className="text-gray-700 mb-6">
                        DELIVETTER was created by a multidisciplinary team of
                        Data Science students from Universitat Politècnica de
                        València:
                    </p>
